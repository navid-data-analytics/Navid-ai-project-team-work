...
class DecisionMakerMidTermRtt(DecisionMakerMidTerm):
    """
    ...
    def __init__(self,
                 ...
                 days_to_report=60):
        """
        Construct a new DecisionMakerMidTerm  for RTT feature.
        It inherits from DecisionMakerMidTerm Class while
        DecisionMakerMidTerm has inherited from the base Class
        ...
        """
        super(DecisionMakerMidTermRtt, self).__init__(
            app_id=app_id,
            metric=metric,
